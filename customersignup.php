...
<body>
    ...
    <div class="card">
        <form action="savecustomer.php" method="post" id="savecustomer">
            <p class="subtitle" style="color: #000">Already Have an Account ? <a href="customerlogin.php" style="color: #000">Sign In</a></p>
            <div class="email-login">
                ...
                <label for="firstname"  style="color: #000"><b>First Name</b></label>
                <input type="text" placeholder="Enter First Name" name="firstname" id="firstname">
                <label for="lastname"  style="color: #000"><b>Last Name</b></label>
                <input type="text" placeholder="Enter Last Name" name="lastname" id="lastname">
                <label for="province"  style="color: #000"><b>Province</b></label>
                ...
                <label for="city"  style="color: #000"><b>City</b></label>
                <select id="city" name="city">
                    <option value=""></option>
                </select>
                <label for="country"  style="color: #000"><b>Country</b></label>
