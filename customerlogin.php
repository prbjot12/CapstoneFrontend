...
<body>
    ...
    <h1 class="title text-center">Customer</h1>
    <h2 class="title text-center">Log in</h2>
    <div class="card">
        <form id="logincustomer" method="post" action="checkcustomerlogin.php">
            <p class="subtitle" style="color: #000;">Don't have an account? <a href="customersignup.php" style="color: #000;"> sign Up</a></p>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="contact-info">
                        <div class="footer-heading">
                            <h4 style="color: #000">Contact Information</h4>
                        </div>
