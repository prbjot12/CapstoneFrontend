...
<body>
    ...
    <h1 class="text-center" style="color: #000">Contact Us</h1>
                            ...
                            <div class="left-content">
                                <div class="row">
                                    <div class="col-md-6">
                                            ...
                                            <input name="name" id="yourname" type="text" class="form-control" id="name" placeholder="Your name..." required="">
                                    </div>
                                    <div class="col-md-6">
                                            <label for="subject">Subject</label>
                                            <input name="subject" id="subject" type="text" class="form-control" id="subject" placeholder="Subject..." required="">
                                    </div>
                                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <div class="right-content">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="content">
                                            <p style="color: #000">Etiam viverra nibh at lorem hendrerit porta non nec ligula. Donec hendrerit porttitor pretium.</p>
                                            <ul>
                                                ...
                                                <li style="color: #000"><span style="color: #000">Address:</span><i class="fa fa-map-marker"></i> 212 Barrington Court New York</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
