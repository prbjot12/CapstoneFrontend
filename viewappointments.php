...
<body>
    ...
    <h1 style="text-align:center;">Customer Appointments</h1>
    ...
    <table id="vehicleInventory" class="display" style="width:100%">
        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_array($results, MYSQLI_ASSOC)) {
                ...
                $str_to_print .= "<td><img style='height:150px;width:150px;' alt='Image {$row['Brand']}' src='{$row['VehicleImage']}' class='productImg'/></td>";
